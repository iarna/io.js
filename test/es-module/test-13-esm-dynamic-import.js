// Flags: --mode=esm --harmony-dynamic-import
'use strict';
...
const relativePath = '../fixtures/es-modules-tests/esm/vanilla-esm-module.js';
...
function expectOkNamespace(result) {
  Promise.resolve(result)
    .then(common.mustCall(ns => {
      ...
      assert.deepEqual(ns, { value: 0xcafed00d });
    }));
}
...
(function testScriptOrModuleImport() {
  ...
  expectMissingModuleError(import("./not-an-existing-module.js"));
